...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col justify-center p-5 lg:p-24" style={{ backgroundImage: "url('/background.png')", backgroundSize: "cover", backgroundRepeat: "no-repeat" }}>
      {/* Sign In button */}
      <button
        className="absolute right-5 top-5 cursor-pointer rounded-lg p-2 border border-black transition duration-300 bg-gradient-to-r from-yellow-300 to-orange-500 hover:to-yellow-300"
